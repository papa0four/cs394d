...
class LinearClassifier(nn.Module):
    def __init__(
        ...
        """
        super().__init__()
        # Define a linear layer to map the input to the output classes
        # Input dimension = 3 * h * w, output dimension = num_classes
...
class MLPClassifier(nn.Module):
    def __init__(
        ...
        input_dim = 3 * h * w  # Flattened input size (3 channels, height, and width)
